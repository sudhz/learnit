...
//     bio: 'Jane Smith is a passionate educator with over 10 years of experience in teaching computer science.',
...
//  };
 ...
 return (
    <Card sx={{ width: '100%', margin: 'auto', marginTop: 2, display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
      <CardContent>
        <Typography variant="h4" component="div" sx={{ marginBottom: 2 }}>
          Welcome, {instructor.name}!
        </Typography>
        <Avatar alt="Profile Picture" src="https://example.com/path/to/profile/picture.jpg" sx={{ width: 100, height: 100 }} />
        ...
        <Button variant="contained" color="primary" onClick={handleEditButton} sx={{ marginTop: 2}}>
          Edit Profile
        </Button>
          <br>
          </br>
